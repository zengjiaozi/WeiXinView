...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private List<WeiXinView> tabIndicators;
    ...
    private void initTabIndicator() {
        WeiXinView one = (WeiXinView) findViewById(R.id.id_indicator_one);
        WeiXinView two = (WeiXinView) findViewById(R.id.id_indicator_two);
        WeiXinView three = (WeiXinView) findViewById(R.id.id_indicator_three);
        WeiXinView four = (WeiXinView) findViewById(R.id.id_indicator_four);
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (positionOffset > 0) {
            WeiXinView leftTab = tabIndicators.get(position);
            WeiXinView rightTab = tabIndicators.get(position + 1);
